...
<ps:hidden type="hidden" id="invalid_numeric_value_key" value="%{getText('invalid_numeric_value_key')}"/>
<ps:hidden type="hidden" id="invalid_comma_separated_numeric_value_key" value="%{getText('invalid_comma_separated_numeric_value_key')}"/>
<ps:hidden type="hidden" id="invalid_varchar_value_key" value="%{getText('invalid_varchar_value_key')}"/>
<ps:hidden type="hidden" id="invalid_comma_separated_varchar_value_key" value="%{getText('invalid_comma_separated_varchar_value_key')}"/>
<ps:hidden type="hidden" id="all_records_approved_successfully_key" value="%{getText('all_records_approved_successfully_key')}"/>

<ps:hidden type="hidden" id="missing_omni_query_default_subject_Body_key" value="%{getText('missing_omni_query_default_subject_Body_key')}"/>
<ps:hidden type="hidden" id="email_or_mobile_number_should_be_mandatory_key" value="%{getText('email_or_mobile_number_should_be_mandatory_key')}"/>

<ps:hidden type="hidden" id="missing_sender_user_or_user_expression_key" value="%{getText('missing_sender_user_or_user_expression_key')}"/>
<ps:hidden type="hidden" id="missing_company_or_company_expression_key" value="%{getText('missing_company_or_company_expression_key')}"/>
<ps:hidden type="hidden" id="missing_branch_or_branch_expression_key" value="%{getText('missing_branch_or_branch_expression_key')}"/>
<ps:hidden type="hidden" id="missing_app_or_app_expression_key" value="%{getText('missing_app_or_app_expression_key')}"/>
<ps:hidden type="hidden" id="fill_all_internal_alert_fields_key" value="%{getText('fill_all_internal_alert_fields_key')}"/>
...
<script type="text/javascript">
	...
	var invalid_numeric_value_key = document.getElementById("invalid_numeric_value_key").value;
	var invalid_comma_separated_numeric_value_key = document.getElementById("invalid_comma_separated_numeric_value_key").value;
	var invalid_varchar_value_key = document.getElementById("invalid_varchar_value_key").value;
	var invalid_comma_separated_varchar_value_key = document.getElementById("invalid_comma_separated_varchar_value_key").value;
	
	var missing_omni_query_default_subject_Body_key = document.getElementById("missing_omni_query_default_subject_Body_key").value;
	
	var all_records_approved_successfully_key = document.getElementById("all_records_approved_successfully_key").value;
	
	var email_or_mobile_number_should_be_mandatory_key = document.getElementById("email_or_mobile_number_should_be_mandatory_key").value;
	var missing_sender_user_or_user_expression_key = document.getElementById("missing_sender_user_or_user_expression_key").value;
	var missing_company_or_company_expression_key = document.getElementById("missing_company_or_company_expression_key").value;
	var missing_branch_or_branch_expression_key = document.getElementById("missing_branch_or_branch_expression_key").value;
	var missing_app_or_app_expression_key = document.getElementById("missing_app_or_app_expression_key").value;
	var fill_all_internal_alert_fields_key = document.getElementById("fill_all_internal_alert_fields_key").value;
