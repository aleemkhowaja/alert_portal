...
$.struts2_jquery.require("SubscriptionList.js", null, jQuery.contextPath
		+ "/path/js/alert/subscriptions/");
</script>

<table id="SubscriptionList_<ps:property value="_pageRef" escapeHtml="true"/>"  width="60%" border="0"
	cellspacing="0">
	<tr>
	...
	<td colspan="2" align="right">    
		<psj:a button="true" onclick="showSubscriptionListById()">
