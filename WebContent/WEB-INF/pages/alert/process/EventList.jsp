...
$.struts2_jquery.require("EventList.js", null, jQuery.contextPath
		+ "/path/js/alert/events/event/");
</script>

<table id="EventList_<ps:property value="_pageRef" escapeHtml="true"/>"  width="60%" border="0"
	cellspacing="0">
	<tr>
	...
	<td colspan="2" align="right">
		<psj:a button="true" onclick="showListEventById()">
